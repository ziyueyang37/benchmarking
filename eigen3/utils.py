...
def mapping(complex_id, model, dataset):
    ...
    path_to_pdb = f'./data/{model}_all_{dataset}/{pdbid}.pdb'  # generated structure
    path_to_data = f'./data/{dataset}_ligand/{complex_id}/protein.pdb'  # crystal structure
    path_to_site = f'./data/{dataset}_ligand/{complex_id}/site.mol2'  # crystal structure
